...
PRETRAINED_MODEL_ARCHIVE_MAP = {
    ...
    "monologg/kobert": "https://huggingface.co/monologg/kobert/resolve/main/pytorch_model.bin",
}
PRETRAINED_CONFIG_ARCHIVE_MAP = {
    ...
    "monologg/kobert": "https://huggingface.co/monologg/kobert/resolve/main/config.json",
}
